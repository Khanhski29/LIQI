        ...
        <>
            <div className='container wide header__top'>
                <div className='row header__bar'>
                    <div className='col lg-1 md-1 lmd-1 sm-4 header__logo'>
                        <Link to="/" onClick={closeMenu}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="33" height="39" viewBox="0 0 33 39" fill="none">
                                ...
                                <defs>
                                <filter id="filter0_d_210_180" x="0" y="0" width="32.4875" height="39" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                    ...
                    <div className='col lg-5 md-5 lmd-8 sm-4 header__menu-col'>
                        ...
                        {isLoggedIn ? (
                            <ul className='row no-gutters'>
                                <li className='col lg-o-6 lg-3 md-o-5 md-3 lmd-12 sm-12'>
                                    <Link to={ROUTERS.USER.PROFILE}>Hồ Sơ</Link>
                                </li>
            ...
            <div
                className={`header__drawer-overlay${isMenuOpen ? " header__drawer-overlay--open" : ""}`}
                onClick={closeMenu}
